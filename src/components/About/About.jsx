    ...
    <Container id="about">
      <Row className="d-flex justify-content-center">
        <Col xs={10} lg={9} xl={8} className="my-5">
          <h2>About Me</h2>        
          <p><Image src="http://localhost:3000/edited-by-catherine/images/site/about.jpg" alt="Catherine" style={{width: "300px"}} className="float-start me-4 mb-4" />My editorial experience runs the gamut from photographic, award-winning nonfiction to highly commercial, older YA and everything in between. This is a sample of the published books and projects I have recently worked on as a freelance editor (click on a book jacket to learn more).</p>
