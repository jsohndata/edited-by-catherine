...
export default function Home() {
  ...
  <div className="parent-container">
        ...
        <Banner 
          ...
          textRight={<p>With more than twenty years of experience in children's publishing—including over a decade in the trenches at a Big Five trade imprint—I know the ins and outs of how to craft a query letter, how to find the right agent, and, most importantly, how to develop a manuscript and help a writer create the best possible version of a story.</p>} 
        />
        <Gallery />
